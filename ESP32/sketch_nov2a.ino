...
const char* ssid = "Hao_Thai";             
const char* password = "h@oth@i30082002";  
        ...
        if (client.available()) {
          ...
          if (c == '\n') {
            if (currentLine.length() == 0) {
              ...
              client.println("  <link href=\"https:
              ...
              client.println("        });");
              client.println("    }");
              client.println("    setInterval(updateValues, 500);"); 
              client.println("  </script>");
              client.println("</body>");
              client.println("</html>");
              client.println();
